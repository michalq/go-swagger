...
import (
	...
	"github.com/michalq/go-swagger/examples/composed-auth/restapi/operations"

	auth "github.com/michalq/go-swagger/examples/composed-auth/auth"
	models "github.com/michalq/go-swagger/examples/composed-auth/models"
)
