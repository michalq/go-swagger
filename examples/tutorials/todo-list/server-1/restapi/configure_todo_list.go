...
import (
	...
	"github.com/michalq/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/michalq/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
