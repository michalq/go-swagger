...
import (
	...
	"github.com/michalq/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/michalq/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
