...
import (
	...
	"github.com/michalq/go-swagger/examples/tutorials/custom-server/gen/restapi"
	"github.com/michalq/go-swagger/examples/tutorials/custom-server/gen/restapi/operations"
)
